...
class IWD_Opc_Helper_Data extends Mage_Core_Helper_Abstract{
	...
	public function sendNewsletterMail($registrationTemplateId, $emailTemplateVariables, $receiverDetail)
    {
    	$newsletterTemplate = Mage::getModel('newsletter/template')->load($registrationTemplateId);

		$senderName = $newsletterTemplate->getTemplateSenderName();
		$senderEmail = $newsletterTemplate->getTemplateSenderEmail();
		$templateSubject = $newsletterTemplate->getTemplateSubject();

		//Appending the Custom Variables to Template.
		$processedTemplate = $newsletterTemplate->getProcessedTemplate($emailTemplateVariables);
