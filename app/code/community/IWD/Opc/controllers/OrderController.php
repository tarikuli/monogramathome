<?php
class IWD_Opc_OrderController extends Mage_Core_Controller_Front_Action {
...
// 		echo "<br>" . Mage::app ()->getRequest ()->starterkit;
		...
		#$customerObject = Mage::getModel ( 'customer/customer' )->load ( Mage::app ()->getRequest ()->email );
		$customerObject = Mage::getModel ( 'customer/customer' )->loadByEmail (trim( Mage::app ()->getRequest ()->email));
