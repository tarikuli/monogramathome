...
class IWD_Opc_Block_Lipp extends  Mage_Core_Block_Template{
    ...
    public function getJsonConfig(){
        ...
        $config->setData('setExpressCheckout', $this->getUrl('ambassador/express/start', array('_secure' => $_secure)));
        $config->setData('setExpressCheckoutUk', $this->getUrl('ambassador/expressuk/start', array('_secure' => $_secure)));
