 ...
 */
/**
 * Contact comments resource collection model
 *
 * @category    Julfiker
 * @package     Julfiker_Contact
 * @author      Ultimate Module Creator
 */
class Julfiker_Contact_Model_Resource_Contact_Comment_Contact_Collection extends Julfiker_Contact_Model_Resource_Contact_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('julfiker_contact/contact_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.contact_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('julfiker_contact/contact_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.contact_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
